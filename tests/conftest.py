...
from weather.db.utils import create_database, drop_database
from weather.services.redis.dependency import get_redis_pool
from weather.settings import settings
from weather.web.application import get_app
...
async def _engine(anyio_backend: Any) -> AsyncGenerator[AsyncEngine]:
    ...
    :yield: new engine.
    """
    from weather.db.meta import meta
    from weather.db.models import load_all_models
